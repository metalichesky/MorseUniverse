...
import com.example.morsedetector.model.NoiseType
import com.example.morsedetector.model.WaveformType
import kotlinx.android.synthetic.main.item_waveform_type.view.*

class NoiseTypeAdaptor: RecyclerView.Adapter<NoiseTypeAdaptor.NoiseTypeViewHolder>() {
    ...
    inner class NoiseTypeViewHolder(val view: View): RecyclerView.ViewHolder(view) {

        fun bind(type: NoiseType, position: Int) {
